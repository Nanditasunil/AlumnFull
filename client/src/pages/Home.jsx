          ...
          className='bg-primary px-4 rounded-lg'>
            ...
            <div className='flex items-center justify-between py-4'>
              ...
              {posting ? (
                ...
                type='submit'
                title='Post'
                containerStyles='bg-[#5a189a] text-white py-1 px-6 rounded-full font-semibold text-sm'/>
              )}
              </div>
            </div>
          </form>
              ...
              <div key={_id} className='flex items-center justify-between'>
                ...
                <div className="flex gap-1">
                  <CustomButton
                        ...
                        containerStyles='bg-[#9d4edd] text-xs text-white px-1.5 py-1 rounded-full'
                  />
                   <CustomButton
                                          title='Deny'
            ...
            suggestedFriends?.map((friend) => (
              <div className='flex items-center justify-between' key={friend._id}>
                ...
                <div className="flex gap-1">
                  ...
                  >
                    <BsPersonFillAdd size={20} className='text-[#9d4edd]'/>
                  </button>
                </div>
              </div>
            ))
